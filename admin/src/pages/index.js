...
import { 
  ...
  FiCheckCircle, FiAlertTriangle, FiInfo, FiX, FiArrowRight
} from 'react-icons/fi';
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white shadow-sm rounded-xl p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/items" className="text-blue-600 text-xs font-medium flex items-center">
        ...
        <div className="bg-white shadow-sm rounded-xl p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/categories" className="text-blue-600 text-xs font-medium flex items-center">
              View <FiArrowRight className="ml-1 h-3 w-3" />
            </Link>
          </div>
        ...
        <div className="bg-white shadow-sm rounded-xl p-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center p-2 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <div className="flex justify-between">
                  <span className="font-medium text-xs text-gray-800">Admin Panel</span>
            ...
            <div className="flex items-center p-2 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <div className="flex justify-between">
                  <span className="font-medium text-xs text-gray-800">API Server</span>
                  <span className="text-green-600 text-xs font-medium">Online</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center p-2 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                <div className="flex justify-between">
                  <span className="font-medium text-xs text-gray-800">Database</span>
                  <span className="text-yellow-600 text-xs font-medium">Limited</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-blue-50 p-2 rounded-lg mt-2">
              <p className="text-xs text-blue-600">
                <FiInfo className="inline-block mr-1 h-3 w-3" /> Using fallback database
              </p>
            </div>
          </div>
        </div>
